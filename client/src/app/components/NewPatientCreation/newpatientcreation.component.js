...
var NewPatientCreationComponent = (function () {
    function NewPatientCreationComponent(sanitized, http) {
        ...
        this.pCurrentAddress = "";
        this.pPermanentAddress = "";
        this.sameTempAddress = false;
        ...
        this.copyTempAddressToPerAddress = function () {
            if (_this.sameTempAddress) {
                _this.pPermanentAddress = "";
            }
            else {
                _this.pPermanentAddress = _this.pCurrentAddress;
            }
